...
$('.add-widget').click(function(){
    ...
    $("#widget-palette-modal").outerWidth($("#widget-canvas").width());
    var modalLeftAdjust = ($(".page-body").width() - $("#widget-canvas").width()) / 2;
    $("#widget-palette-modal").css("left", modalLeftAdjust);
